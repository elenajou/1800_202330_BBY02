...
function writeIngredients() {
  db.collection("recipes").where("name", "==", "Whiskey Peach")
    .get()
  ...
  db.collection("recipes").where("name", "==", "Crème Brûlée")
    .get()
    .then(function(querySnapshot) {
      querySnapshot.forEach(function(doc) {
        ingredientsRef = db.collection("recipes").doc(doc.id).collection("ingredients");
  ...
  db.collection("recipes").where("name", "==", "Peanut Butter Cups")
    .get()
    .then(function(querySnapshot) {
      querySnapshot.forEach(function(doc) {
        ingredientsRef = db.collection("recipes").doc(doc.id).collection("ingredients");
  ...
  db.collection("recipes").where("name", "==", "Cloud Bread")
    .get()
    .then(function(querySnapshot) {
      querySnapshot.forEach(function(doc) {
        ingredientsRef = db.collection("recipes").doc(doc.id).collection("ingredients");
    ...
    db.collection("recipes").where("name", "==", "Chocolate And Peanut Butter Fudge")
    .get()
    .then(function(querySnapshot) {
      querySnapshot.forEach(function(doc) {
        ingredientsRef = db.collection("recipes").doc(doc.id).collection("ingredients");
